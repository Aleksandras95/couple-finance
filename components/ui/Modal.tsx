...
export function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center max-w-[430px] mx-auto h-fit">
      {/* Backdrop */}
      <div
        ref={overlayRef}
      ...
      <div className="relative w-full bg-surface rounded-t-3xl shadow-2xl slide-up max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto mobile-scroll">{children}</div>
      </div>
    </div>
  );
}
